...
def validar(contrato: Contrato) -> list[ErrorParser]:
    ...
    _validar_input(contrato, errores)
...
def _validar_input(contrato: Contrato, errores: list[ErrorParser]) -> None:
    """Los inputs deben tener tipo no vacío."""
